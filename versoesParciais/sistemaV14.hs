...
acaoUm inventario = do
    ...
    case addItem horario item inventario of
        Left (_, logErro) -> do
            salvarLog logErro
            putStrLn "\n Erro na Adicao do Item: Log de Erro salvo.\n"
            return inventario
        Right (novoInv, logSucesso) -> do
            salvarLog logSucesso
...
acaoDois inventario = do
    ...
    case removeItem horario codigoItem quantidadeItem inventario of
        Left (_, logErro) -> do
            salvarLog logErro
            putStrLn "\n Erro na remocao do Item: Log de Erro salvo.\n"
            return inventario
        Right (novoInv, logSucesso) -> do
            salvarLog logSucesso
            salvarInventario arquivoInv novoInv
...
acaoTres inventario = do
    ...
    case updateQty horario inventario codigoItem quantidadeItem of
        Left (_, logErro) -> do
            salvarLog logErro
            putStrLn "\nErro na atribuicao de uma quantidade: Log de Erro salvo.\n"
            return inventario
        Right (novoInv, logSucesso) -> do
            salvarLog logSucesso
            salvarInventario arquivoInv novoInv
...
acaoQuatro inventario = do
    ...
    case deletaItem horario inventario codigoItem of
        Left (_, logErro) -> do
            salvarLog logErro
            putStrLn "\nErro ao deletar item: Log de Erro salvo.\n"
            return inventario
        Right (novoInv, logSucesso) -> do
            salvarLog logSucesso
            salvarInventario arquivoInv novoInv
...
acaoCinco inventario = do
    ...
    case consultarInventario horario inventario of
        Left (_, logErro) -> do
            salvarLog logErro
            putStrLn "\nErro na consulta de inventario: log de erro salvo\n"
