...
updateQty :: UTCTime -> Inventario -> String -> Int -> Either (String, LogEntry) (Inventario, LogEntry)
...
deletaItem :: UTCTime -> Inventario -> String -> Either (String, LogEntry) (Inventario, LogEntry)
...
main = do 
    ...
    case addItem horarioAgr itemTesteUm inventarioTeste of
        ...
        Right (novoInv, _) -> do
            ...
            case consultarInventario horarioAgr novoInv of
                Left (erro, _) -> print erro
                Right (consulta, _) -> do
                    print consulta
